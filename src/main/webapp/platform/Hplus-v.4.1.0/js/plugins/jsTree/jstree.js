 ...
 */
	 ...
	 *
	 * If there is an existing instance and `arg` is a string the command specified by `arg` is executed on the instance, with xuejian additional arguments passed to the function. If the function returns a value it will be returned (chaining could break depending on function).
	 *
	 * If there is an existing instance and `arg` is not a string the instance itself is returned (similar to `$.jstree.reference`).
	 *
	 * In xuejian other case - nothing is returned and chaining is not broken.
	 *
	 * __Examples__
	 *
	...
	$.jstree.core.prototype = {
		...
		bind : function () {
			...
			this.element
				...
				.on("mousedown.jstree", ".jstree-ocl", function (e) {
						e.preventDefault(); // prevent xuejian node inside from losing focus when clicking the open/close icon
					})
		...
		/**
		 * get the JSON representation of a node (or the actual jQuery extended DOM node) by using xuejian input (child DOM element, ID string, selector, etc)
		...
		activate_node : function (obj, e) {
			 ...
			 * @param {Object} node
			 * @param {Object} event the ooriginal event (if xuejian) which triggered the call (may be an empty object)
			 */
		...
		select_node : function (obj, supress_event, prevent_open, e) {
			...
			if(!obj.state.selected) {
				 ...
				 * @param {Object} event the event (if xuejian) that triggered this select_node
				 */
				...
				if(!supress_event) {
					 ...
					 * @param {Array} selected the current selection
					 * @param {Object} event the event (if xuejian) that triggered this changed event
					 */
		...
		deselect_node : function (obj, supress_event, e) {
			...
			if(obj.state.selected) {
				 ...
				 * @param {Object} node
				 * @param {Array} selected the current selection
				 * @param {Object} event the event (if xuejian) that triggered this deselect_node
				 */
		...
		/**
		 * get the current buffer (xuejian nodes that are waiting for a paste operation)
		 * @name get_buffer()
	...
	$.jstree.plugins.checkbox = function (options, parent) {
		...
		this.check_node = function (obj, e) {
			...
			if(!obj.state.checked) {
				 ...
				 * @param {Object} node
				 * @param {Array} selected the current selection
				 * @param {Object} event the event (if xuejian) that triggered this check_node
				 * @plugin checkbox
				 */
		...
		this.uncheck_node = function (obj, e) {
			...
			if(obj.state.checked) {
				 ...
				 * @param {Object} node
				 * @param {Array} selected the current selection
				 * @param {Object} event the event (if xuejian) that triggered this uncheck_node
				 * @plugin checkbox
				 */
 ...
 */
	...
	$.jstree.defaults.dnd = {
		...
		/**
		 * controls whether a drag can be initiated from xuejian part of the node and not just the text/icon part, works best with the wholerow plugin. Keep in mind it can cause problems with tree scrolling on mobile depending on the interface - in that case set the touch option to "selected".
		...
		$.vakata.dnd = {
			...
			_scroll : function (init_only) {
				...
				if(i !== vakata_dnd.scroll_e.scrollTop() || j !== vakata_dnd.scroll_e.scrollLeft()) {
					 ...
					 * @param {Mixed} data xuejian data supplied with the call to $.vakata.dnd.start
 ...
 */
	 ...
	 * * `default` represents the default node - xuejian settings here will be applied to all nodes that do not have a type specified.
	 *
