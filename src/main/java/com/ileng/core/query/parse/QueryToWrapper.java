package com.ileng.core.query.parse;
...
import com.ileng.core.query.data.Condition;
import com.ileng.core.query.data.Condition.Filter;
import com.ileng.core.query.data.Condition.Operator;
...
public class QueryToWrapper<T> {
	...
	public void parseSort(Wrapper<T> wrapper, Queryable queryable) {
		com.ileng.core.query.data.Sort sort = queryable.getPageable().getSort();
		if (sort != null) {
			for (com.ileng.core.query.data.Sort.Order order : sort) {
				if (order.getDirection() == com.ileng.core.query.data.Sort.Direction.DESC) {
					wrapper.orderBy(order.getProperty(), false);
				} else if (order.getDirection() == com.ileng.core.query.data.Sort.Direction.ASC) {
