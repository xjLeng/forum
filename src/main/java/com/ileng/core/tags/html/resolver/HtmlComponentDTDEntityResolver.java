package com.ileng.core.tags.html.resolver;
...
public class HtmlComponentDTDEntityResolver implements EntityResolver, Serializable {
    ...
    public InputSource resolveEntity(String publicId, String systemId) {
        ...
        if (systemId != null) {
            ...
            if (systemId.startsWith(HOP_DYNAMIC_STATEMENT)) {
                LOGGER.debug(
                        "recognized hop html component namespace attempting to resolve on classpath under com.ileng/core/tags/html/dtd/");
    ...
    public static void main(String[] args) {
        String path = "com/ileng/core/tags/html/dtd/html-component-1.0.dtd";

        System.out.println(HtmlComponentDTDEntityResolver.class.getClass().getResource("/").getPath());
    }
