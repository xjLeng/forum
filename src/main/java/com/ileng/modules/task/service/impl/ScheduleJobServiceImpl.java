package com.ileng.modules.task.service.impl;

import com.ileng.core.common.service.impl.CommonServiceImpl;
import com.ileng.core.quartz.QuartzManager;
import com.ileng.modules.task.entity.ScheduleJob;
import com.ileng.modules.task.mapper.ScheduleJobMapper;
import com.ileng.modules.task.service.IScheduleJobService;
import com.ileng.modules.task.utils.ScheduleJobUtils;
...
public class ScheduleJobServiceImpl extends CommonServiceImpl<ScheduleJobMapper, ScheduleJob>
	...
	public void updateCron(String jobId) throws SchedulerException {
		...
		if (com.ileng.core.quartz.data.ScheduleJob.STATUS_RUNNING.equals(scheduleJob.getJobStatus())) {
	...
	public void changeStatus(String jobId, String cmd) throws SchedulerException {
		...
		if ("stop".equals(cmd)) {
			...
			scheduleJob.setJobStatus(com.ileng.core.quartz.data.ScheduleJob.STATUS_NOT_RUNNING);
		} else if ("start".equals(cmd)) {
			scheduleJob.setJobStatus(com.ileng.core.quartz.data.ScheduleJob.STATUS_RUNNING);
